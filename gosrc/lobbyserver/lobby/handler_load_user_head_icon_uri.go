...
func replyLoadUserHeadIconSuccess(w http.ResponseWriter, msg *MsgLoadUserHeadIconURIReply) {
...
func replyLoadUserHeadIconError(w http.ResponseWriter, errorCode int32) {
	var loadUserHeadIconURIReply = &MsgLoadUserHeadIconURIReply{}
	var code = errorCode
...
func handleLoadUserHeadIconURI(w http.ResponseWriter, r *http.Request, userID string) {
	...
	if r.ContentLength < 1 {
		...
		replyLoadUserHeadIconError(w, int32(MsgError_ErrRequestInvalidParam))
		return
	}
	...
	msg := &MsgLoadUserHeadIconURI{}
	err := proto.Unmarshal(message, msg)
	if err != nil {
		log.Println("onMessageCreateRoom, Unmarshal err:", err)
		replyLoadUserHeadIconError(w, int32(MsgError_ErrDecode))
		return
	}
