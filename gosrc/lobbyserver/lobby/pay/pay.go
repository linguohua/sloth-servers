...
// 进入房间扣钱
func (*myPayUtil) DoPayForEnterRoom(roomID string, userID string) (remainDiamond int, errCode int32) {
	return doPayForEnterRoom(roomID, userID)
}

func (*myPayUtil) Refund2UserWith(roomID string, userID string, handFinish int) (remainDiamond int, errCode int32) {
