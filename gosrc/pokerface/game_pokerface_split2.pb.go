...
func (PlayerState) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (DisbandState) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (TipCode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (RoomDeleteReason) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (KickoutResult) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (EnterRoomStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*MsgPlayerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*PlayerHandScoreRecord) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*MsgRoomHandScoreRecord) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*MsgRoomInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*RoomScoreRecords) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*MsgDisbandAnswer) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*MsgDisbandNotify) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*MsgGameOverPlayerStat) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*MsgGameOver) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*MsgRoomShowTips) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*MsgRoomDelete) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*MsgKickout) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*MsgKickoutResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*MsgEnterRoomResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*MsgDonate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func init() { proto.RegisterFile("game_pokerface_split2.proto", fileDescriptor0) }
